...
→ Maintained 12.0%–12.3% average interest rate  
→ Borrower solvency stable: ~13.3% average DTI  
→ Positive net spread ensures sustainable portfolio profitability  
...
* Used loan purpose & term correlation to identify higher-risk segments.
* Findings guided credit policy adjustments and targeted risk mitigation.

### 📈 Growth, Product & Market Intelligence
* Funding scale-up
* 14K Model: $9.2M → $22.2M (141% growth)
* 38K Model: $19.8M → $54M (172% growth)
* Peak lending season: December (Q4 acceleration)
* 36-month term dominance: 66%–73.2% share ($319M in large model)
* Debt Consolidation largest driver (~50% of funded volume)
